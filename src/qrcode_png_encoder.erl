...
%% @doc Very simple PNG encoder.
-spec png_encode(qrcode()) -> binary().
png_encode(#qrcode{dimension = Dim, data = Data}) ->
	MAGIC = <<137, 80, 78, 71, 13, 10, 26, 10>>,
	Size = Dim * 8,
	IHDR = png_chunk(<<"IHDR">>, <<Size:32, Size:32, 8:8, 2:8, 0:24>>),
	IDAT = png_chunk(<<"IDAT">>, get_pixel_data(Dim, Data)),
	IEND = png_chunk(<<"IEND">>, <<>>),
