...
%% @doc Generates all eight masked versions of the bit matrix
-spec generate(qr_params(), list()) -> list().
...
%% @doc Selects the lowest penalty candidate from a list of bit matrices.
-spec select(list()) -> tuple().
select([H|T]) ->
